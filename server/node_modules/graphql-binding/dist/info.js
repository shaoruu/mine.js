...
function buildInfoForAllScalars(rootFieldName, schema, operation) {
    ...
    var selections;
    if (graphql_1.isInterfaceType(namedType) || graphql_1.isObjectType(namedType)) {
...
function makeSubInfo(info, path, fragment) {
    ...
    if (graphql_1.isScalarType(returnType)) {
    ...
    while (fieldsToTraverse.length > 0) {
        ...
        if (!graphql_1.isObjectType(currentType)) {
        ...
        if (!graphql_1.isObjectType(currentFieldType)) {
