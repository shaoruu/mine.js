...
var _1 = require(".");
ava_1.default('addFragmentToInfo: add field by simple query', function (t) {
...
ava_1.default('addFragmentToInfo: add field to array payload', function (t) {
    var schema = graphql_1.buildSchema("\n  type Query {\n    books: [Book!]!\n  }\n\n  type Book {\n    title: String\n    extraField: String\n  }\n  ");
...
ava_1.default('addFragmentToInfo: add field by fragment', function (t) {
    var schema = graphql_1.buildSchema("\n  type Query {\n    book: Book\n  }\n\n  type Book {\n    title: String\n    extraField: String\n  }\n  ");
    var info = info_1.buildInfoFromFragment('book', schema, 'query', "{ title }");
...
ava_1.default("addFragmentToInfo: dont add field by fragment when type doesn't match", function (t) {
    var schema = graphql_1.buildSchema("\n  type Query {\n    book: Book\n  }\n\n  type Book {\n    title: String\n    extraField: String\n  }\n  ");
    var info = info_1.buildInfoFromFragment('book', schema, 'query', "{ title }");
    t.throws(function () {
