...
export function computeSkinScale(width) {
  return width / 64.0
}
...
export function hasTransparency(context, x0, y0, w, h) {
...
export function fixOpaqueSkin(context, width) {
...
export function convertSkinTo1_8(context, CanvasRenderingContext2D, width) {
  const scale = computeSkinScale(width)
